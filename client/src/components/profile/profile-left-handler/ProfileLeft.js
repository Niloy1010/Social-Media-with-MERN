...
const ProfileLeft = (props) => {
    ...
    const editProfileContent = auth.isAuthenticated === true && profile.user._id === auth.user.id ? (  
    ...
    const socialContent = !isEmpty(profile.social) ? (
        <div className="text-left mt-3">
            <h6 className={`${styles.socialLink} p-2`}><span>Social Link</span></h6>
        ...
        <i className={`${styles.mylink} fa fa-instagram fa-2x `}
        ></i>
        </a>)
        }
    ...
    return (
        <div className="row">
            ...
            <div className="imageHolder">
                            <img src={profile.user.displayPicture} alt="" className="w-100 mt-0"/>
        ...
        <div className="text-left mt-3">
            <h6 className={`${styles.skillink} p-2`}><span>Skills</span></h6>
            </div>
