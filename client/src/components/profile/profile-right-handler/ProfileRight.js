        ...
        return (
            <div>
                <div className={`${styles.cardbio} card`}>
                    ...
                    {firstName} {lastName}</h1>
                        ...
                        <p className="card-text">
                            {isEmpty(profile.bio) ? (<span className="text-left d-block">I am a {profile.status}</span>) : (<span>{profile.bio}</span>)}
                            </p>
                    </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div style={{
                                display: 'flex'
                                }}><FaceIcon iconStyle={styles.largeIcon}  />  
                        <h4
                        className= {`${this.state.showInformation==='posts'?styles.btnSelected: styles.btnUnselected} ${styles.toggleButton} pb-2 mb-3 w-100`}
                    ...
                    <div className="col-sm-4 text-center">
                        <div style={{
                                display: 'flex'
                                }}><SchoolIcon iconStyle={styles.largeIcon}  />   <h4 
                        className= {`${this.state.showInformation==='education'?styles.btnSelected: styles.btnUnselected} ${styles.toggleButton} pb-2 mb-3  w-100`}
                        onClick={this.changeBtnToEducation}
                        >Education</h4>
                      </div>
                        </div>
                    <div className="col-sm-4 text-center"> <div style={{
                                display: 'flex'
                                }}><WorkIcon iconStyle={styles.largeIcon}  />
                        <h4 
                        className= {`${this.state.showInformation==='experience'?styles.btnSelected: styles.btnUnselected} ${styles.toggleButton} pb-2 mb-3 w-100`}
                ...
                {this.state.showInformation==='experience'? profileExperienceContent : null}
                {this.state.showInformation==='education'? profileEducationContent : null}
